...
describe('favoritesReducer', () => {
  ...
  it ('should return the correct state if the action type is ADD_TO_FAVORITES', () => {
    const mockAction = {
  ...
  it ('should return the correct state if the action type is REMOVE_FROM_FAVORITES', () => {
    const mockAction = {
